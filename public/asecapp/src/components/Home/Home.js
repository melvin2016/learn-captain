  ...
  return (
    <div className="slider fullscreen">
      <ul className="slides">
        <li>
          ...
          <div className="caption left-align">
            <h3 style={{ color: "#d9c68c" }}>Learn Captian</h3>
            <h5
              className="light #d9c68c text-lighten-3"
              style={{ color: "#d9c68c" }}
            >
              Simulating students working environment.
            </h5>
          </div>
        </li>
        <li>
          ...
          <div className="caption center-align">
            <h3 className="">
              Built with <i className="material-icons">favorite</i>, Using
            </h3>
      ...
      <div className="fixed-action-btn">
        ...
        <ul>
          <li className="tooltipped" data-position="left" data-tooltip="Login">
            <NavLink className="btn-floating blue" to="/login">
          ...
          >
            <NavLink className="btn-floating green" to="/register">
